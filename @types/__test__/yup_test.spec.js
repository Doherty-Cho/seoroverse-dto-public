...
yup.setLocale({
    mixed: {
        ...
        notType: function notType(_ref) {
            let path = _ref.path, type = _ref.type, value = _ref.value, originalValue = _ref.originalValue;
...
describe('dfffff', () => {
    it('검증 항목간 비교 예제 - 비밀번호 확인', async () => {
        const schema = object().shape({
            ...
            displayContent: string().when('displayYn', (displayYn, schema) => displayYn[0] === 'Y' ? schema.required('표시내용을 입력해주세요.') : schema.nullable()),
        });
        const requestBody = {
            displayYn: 'Y',
...
//# sourceMappingURL=yup_test.spec.js.map