 ...
 */
export const OneBookManagementCreate: import("yup").ObjectSchema<{
    crtr_yr: string;
    book_ttl: string;
    athr_nm: string;
    pblco_nm: string | null | undefined;
...
/** @typedef 한권의책 수정 DTO */
export const OneBookManagementUpdate: import("yup").ObjectSchema<{
    crtr_yr: string;
    book_ttl: string;
    athr_nm: string;
    pblco_nm: string | null | undefined;
...
export const OneBookManagementSearchReq: import("yup").ObjectSchema<{
...
export const OneBookManagementSearchRes: import("yup").ObjectSchema<{
    code: string;
    data: {
        total: number;
        count: number;
...
export const OneBookManagementDetailRes: import("yup").ObjectSchema<{
    code: string;
    data: {
        lgn_id?: string | null | undefined;
        pblco_nm?: string | null | undefined;
